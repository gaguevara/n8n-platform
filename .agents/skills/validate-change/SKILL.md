...
description: Ejecuta validación post-cambio completa. Codex debe usar este skill después de CADA modificación de código. Detecta el stack automáticamente y ejecuta lint, tests y scan.
---
