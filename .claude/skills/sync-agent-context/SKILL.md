...
description: Sincroniza archivos de contexto entre agentes (AGENTS.md, GEMINI.md, CLAUDE.md) cuando cambian documentos de gobernanza. Usar despues de modificar PROJECT_RULES, CONTEXT, AGENT_ROLES u otros docs compartidos.
---
...
- `CLAUDE.md` (raiz) — entry point para Claude Code
